...
function setData()
{
  ...
  localStorage.setItem("EmailKey",inputValue)
  var inputValue= document.getElementById("pass").value;
  localStorage.setItem("passwordKey",inputValue)
...
function getData()
{
    ...
    xhttp.open("GET","htmlquestions.json",true);
    xhttp.send();
}
getData()
...
function showResults(count)
{
    ...
    {   
        ...
        bulletselemets.remove();
         ...
         if(rightanswer >count/2  && count<rightanswer)
         {
